...
!(function (e) {
  ...
  (U.dateRangePickerLanguages = {
    ...
    bg: {
      ...
      "less-than":
        "ÐŸÐµÑ€Ð¸Ð¾Ð´ÑŠÑ‚ Ð¾Ñ‚ Ð²Ñ€ÐµÐ¼Ðµ Ð½Ðµ Ñ‚Ñ€ÑÐ±Ð²Ð° Ð´Ð° Ðµ Ð¿Ð¾Ð²ÐµÑ‡Ðµ Ð¾Ñ‚ %d Ð´Ð½Ð¸",
      "more-than":
        "ÐŸÐµÑ€Ð¸Ð¾Ð´ÑŠÑ‚ Ð¾Ñ‚ Ð²Ñ€ÐµÐ¼Ðµ Ð½Ðµ Ñ‚Ñ€ÑÐ±Ð²Ð° Ð´Ð° Ðµ Ð¿Ð¾-Ð¼Ð°Ð»ÐºÐ¾ Ð¾Ñ‚ %d Ð´Ð½Ð¸",
      "default-more":
        "ÐœÐ¾Ð»Ñ Ð¸Ð·Ð±ÐµÑ€ÐµÑ‚Ðµ Ð¿ÐµÑ€Ð¸Ð¾Ð´ Ð¿Ð¾-Ð´ÑŠÐ»ÑŠÐ³ Ð¾Ñ‚ %d Ð´Ð½Ð¸",
      "default-single": "ÐœÐ¾Ð»Ñ Ð¸Ð·Ð±ÐµÑ€ÐµÑ‚Ðµ Ð´Ð°Ñ‚Ð°",
      "default-less":
        "ÐœÐ¾Ð»Ñ Ð¸Ð·Ð±ÐµÑ€ÐµÑ‚Ðµ Ð¿ÐµÑ€Ð¸Ð¾Ð´ Ð¿Ð¾-ÐºÑŠÑ Ð¾Ñ‚ %d Ð´Ð½Ð¸",
      "default-range":
        "ÐœÐ¾Ð»Ñ Ð¸Ð·Ð±ÐµÑ€ÐµÑ‚Ðµ Ð¿ÐµÑ€Ð¸Ð¾Ð´ Ð¼ÐµÐ¶Ð´Ñƒ %d Ð¸ %d Ð´Ð½Ð¸",
    ...
    de: {
      ...
      "default-range":
        "Bitte einen Datumsbereich zwischen %d und %d Tagen auswÃ¤hlen",
    ...
    ko: {
      ...
      "default-range":
        "%dì™€ %d ì¼ ì‚¬ì´ì˜ ë‚ ì§œ ë²”ìœ„ë¥¼ ì„ íƒí•´ ì£¼ì„¸ìš”",
    ...
    ru: {
      ...
      "next-year": "Ð“Ð¾Ð´",
      "less-than":
        "Ð”Ð¸Ð°Ð¿Ð°Ð·Ð¾Ð½ Ð½Ðµ Ð¼Ð¾Ð¶ÐµÑ‚ Ð±Ñ‹Ñ‚ÑŒ Ð±Ð¾Ð»ÑŒÑˆÐµ %d Ð´Ð½ÐµÐ¹",
      "more-than":
        "Ð”Ð¸Ð°Ð¿Ð°Ð·Ð¾Ð½ Ð½Ðµ Ð¼Ð¾Ð¶ÐµÑ‚ Ð±Ñ‹Ñ‚ÑŒ Ð¼ÐµÐ½ÑŒÑˆÐµ %d Ð´Ð½ÐµÐ¹",
      "default-more":
        "ÐŸÐ¾Ð¶Ð°Ð»ÑƒÐ¹ÑÑ‚Ð° Ð²Ñ‹Ð±ÐµÑ€Ð¸Ñ‚Ðµ Ð´Ð¸Ð°Ð¿Ð°Ð·Ð¾Ð½ Ð±Ð¾Ð»ÑŒÑˆÐµ %d Ð´Ð½ÐµÐ¹",
      "default-single": "ÐŸÐ¾Ð¶Ð°Ð»ÑƒÐ¹ÑÑ‚Ð° Ð²Ñ‹Ð±ÐµÑ€Ð¸Ñ‚Ðµ Ð´Ð°Ñ‚Ñƒ",
      "default-less":
        "ÐŸÐ¾Ð¶Ð°Ð»ÑƒÐ¹ÑÑ‚Ð° Ð²Ñ‹Ð±ÐµÑ€Ð¸Ñ‚Ðµ Ð´Ð¸Ð°Ð¿Ð°Ð·Ð¾Ð½ Ð¼ÐµÐ½ÑŒÑˆÐµ %d Ð´Ð½ÐµÐ¹",
      "default-range":
        "ÐŸÐ¾Ð¶Ð°Ð»ÑƒÐ¹ÑÑ‚Ð° Ð²Ñ‹Ð±ÐµÑ€Ð¸Ñ‚Ðµ Ð´Ð¸Ð°Ð¿Ð°Ð·Ð¾Ð½ Ð¼ÐµÐ¶Ð´Ñƒ %d Ð¸ %d Ð´Ð½ÑÐ¼Ð¸",
      "default-default":
        "ÐŸÐ¾Ð¶Ð°Ð»ÑƒÐ¹ÑÑ‚Ð° Ð²Ñ‹Ð±ÐµÑ€Ð¸Ñ‚Ðµ Ð´Ð¸Ð°Ð¿Ð°Ð·Ð¾Ð½",
      time: "Ð’Ñ€ÐµÐ¼Ñ",
      hour: "Ð§Ð°ÑÑ‹",
      minute: "ÐœÐ¸Ð½ÑƒÑ‚Ñ‹",
    },
    uk: {
      ...
      "next-year": "Ð Ñ–Ðº",
      "less-than":
        "Ð”Ñ–Ð°Ð¿Ð°Ð·Ð¾Ð½ Ð½Ðµ Ð¼Ð¾Ð¶Ðµ Ð±ÑƒÑ‚Ð¸ Ð±Ñ–Ð»ÑŒÑˆ Ð½Ñ–Ð¶ %d Ð´Ð½Ñ–Ð²",
      "more-than":
        "Ð”Ñ–Ð°Ð¿Ð°Ð·Ð¾Ð½ Ð½Ðµ Ð¼Ð¾Ð¶Ðµ Ð±ÑƒÑ‚Ð¸ Ð¼ÐµÐ½ÑŒÑˆ Ð½Ñ–Ð¶ %d Ð´Ð½Ñ–Ð²",
      "default-more":
        "Ð‘ÑƒÐ´ÑŒ Ð»Ð°ÑÐºÐ° Ð²Ð¸Ð±ÐµÑ€Ñ–Ñ‚ÑŒ Ð´Ñ–Ð°Ð¿Ð°Ð·Ð¾Ð½ Ð±Ñ–Ð»ÑŒÑˆÐµ %d Ð´Ð½Ñ–Ð²",
      "default-single": "Ð‘ÑƒÐ´ÑŒ Ð»Ð°ÑÐºÐ° Ð²Ð¸Ð±ÐµÑ€Ñ–Ñ‚ÑŒ Ð´Ð°Ñ‚Ñƒ",
      "default-less":
        "Ð‘ÑƒÐ´ÑŒ Ð»Ð°ÑÐºÐ° Ð²Ð¸Ð±ÐµÑ€Ñ–Ñ‚ÑŒ Ð´Ñ–Ð°Ð¿Ð°Ð·Ð¾Ð½ Ð¼ÐµÐ½ÑˆÐµ %d Ð´Ð½Ñ–Ð²",
      "default-range":
        "Ð‘ÑƒÐ´ÑŒ Ð»Ð°ÑÐºÐ° Ð²Ð¸Ð±ÐµÑ€Ñ–Ñ‚ÑŒ Ð´Ñ–Ð°Ð¿Ð°Ð·Ð¾Ð½ Ð¼Ñ–Ð¶ %d Ñ‚Ð° %d Ð´Ð½ÑÐ¼Ð¸",
    ...
    ja: {
      ...
      "next-month": "æ¥æœˆ",
      "next-year": "æ¥å¹´",
      "less-than": "æ—¥ä»˜ã®ç¯„å›²ã¯ï¼…dæ—¥ä»¥ä¸Šã«ã™ã¹ãã§ã¯ã‚ã‚Šã¾ã›ã‚“",
      "more-than": "æ—¥ä»˜ã®ç¯„å›²ã¯ï¼…dæ—¥ã‚’ä¸‹å›žã£ã¦ã¯ã„ã‘ã¾ã›ã‚“",
      "default-more": "ï¼…dæ—¥ã‚ˆã‚Šã‚‚é•·ã„æœŸé–“ã‚’é¸æŠžã—ã¦ãã ã•ã„",
      "default-less": "ï¼…dæ—¥æœªæº€ã®æœŸé–“ã‚’é¸æŠžã—ã¦ãã ã•ã„",
      "default-range": "ï¼…dæ—¥ã¨ï¼…dæ—¥ã®é–“ã®æ—¥ä»˜ç¯„å›²ã‚’é¸æŠžã—ã¦ãã ã•ã„",
    ...
    sk: {
      ...
      "default-range": "ProsÃ­m zvoÄ¾te rozsah medzi %d a %d dÅˆami",
